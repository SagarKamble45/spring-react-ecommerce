package com.sagark.ecommerce.project.security;
...
import com.sagark.ecommerce.project.security.jwt.AuthEntryPointJwt;
import com.sagark.ecommerce.project.security.jwt.AuthTokenFilter;
import com.sagark.ecommerce.project.security.services.UserDetailsServiceImpl;
...
//                               .requestMatchers("/api/admin/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(
                List.of("http://localhost:5173", "http://127.0.0.1:5500")
        );
